...
def determine_channel_by_content(
    title: str, content: str, categories: List[str], tags: List[str]
) -> str:
    """
    ...
    try:
        ...
        is_sensitive = any(
            topic in content_sample or topic in title_lower for topic in SENSITIVE_TOPICS
        )
...
def main():
    ...
    parser.add_argument(
        ...
        "-i",
        action="store_true",
        help="Enable interactive mode with approval for each post",
    )
