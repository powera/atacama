...
def run_test_suite(
    ...
    try:
        ...
        if categories:
            ...
            for category in categories:
                if category in all_tests:
                    ...
                    if category == "react_compiler" and all_tests[category]:
                        print(
                            "Warning: React Compiler tests are expensive and require Node.js/npm."
                        )
            ...
            test_modules = [module for modules in all_tests.values() for module in modules]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pattern", help='Only run tests matching pattern (e.g., "test_auth*")')
