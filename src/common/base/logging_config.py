...
def configure_logging(
    log_level: str = "INFO", app_log_level: str = "DEBUG", log_filename: Optional[str] = None
) -> None:
    """
    ...
    logging.info(
        f"Logging initialized: root_level={log_level}, app_level={app_log_level}, log_file={log_file_path}"
    )
