...
class TestUsers(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.user = User(
            ...
            name="Test User",
            channel_preferences=json.dumps({"private": True, "public": True}),
            admin_channel_access=json.dumps({"restricted": "2024-01-15T14:30:00Z"}),
        )
    ...
    def test_get_or_create_user_existing(self):
        ...
        request_user = {"email": "test@example.com", "name": "Test User"}
    ...
    def test_check_channel_access(self, mock_get_manager):
        ...
        with patch("models.users.check_admin_approval") as mock_check_admin:
            ...
            user_with_bad_prefs = User(
                id=3, email="bad@example.com", name="Bad Prefs", channel_preferences="invalid-json"
            )
