...
class TestChannelAccess(ChannelConfigTestBase):
    ...
    def test_public_access(self):
        ...
        self.assertTrue(
            self.manager.check_system_access("public")
        )
        self.assertTrue(
            self.manager.check_system_access("public", email="user@example.com")
        )
        
    def test_private_access(self):
        """Test private channel access requirements."""
        self.assertFalse(
            self.manager.check_system_access("private")  # No email
        )
        self.assertTrue(
            self.manager.check_system_access("private", email="user@example.com")
        )
    ...
    def test_restricted_access(self):
        ...
        # No authentication
        self.assertFalse(
            self.manager.check_system_access("restricted")
        )
