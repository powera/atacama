...
class TestThemeConfig(unittest.TestCase):
    ...
    def test_theme_config_initialization(self):
        ...
        theme = ThemeConfig(name="test_theme", css_files=["style.css", "custom.css"])
    ...
    def test_theme_config_with_custom_values(self):
        ...
        theme = ThemeConfig(
            name="custom_theme", css_files=["theme.css"], layout="two_column", banner=True
        )
    ...
    def test_theme_config_with_empty_css_files(self):
        ...
        theme = ThemeConfig(name="minimal_theme", css_files=[])
    ...
    def test_theme_config_equality(self):
        ...
        theme1 = ThemeConfig(
            name="test_theme", css_files=["style.css"], layout="default", banner=False
        )
        ...
        theme3 = ThemeConfig(
            name="different_theme", css_files=["style.css"], layout="default", banner=False
        )
...
class TestDomainConfig(unittest.TestCase):
    ...
    def test_domain_config_initialization(self):
        ...
        domain = DomainConfig(name="test_domain", channels=["public", "private"], theme="default")
    ...
    def test_allows_all_channels_property(self):
        ...
        domain_restricted = DomainConfig(
            name="restricted", channels=["public", "private"], theme="default"
        )
        self.assertFalse(domain_restricted.allows_all_channels)

        # Domain allowing all channels
        domain_all = DomainConfig(name="all_channels", channels=[], theme="default")
...
class TestDomainManager(DomainManagerTestBase):
    ...
    def test_validate_config_no_domains(self):
        ...
        invalid_config = {"themes": self.valid_config["themes"], "domains": {}}
    ...
    def test_validate_config_missing_default_domain(self):
        ...
        invalid_config = {
            ...
            "domains": {"custom": self.valid_config["domains"]["restricted"]},
        }
    ...
    def test_validate_config_invalid_theme_reference(self):
        ...
        try:
            with self.assertRaises(ValueError) as context:
                DomainManager(invalid_path)
            self.assertIn(
                "Theme 'nonexistent_theme' referenced by domain 'default' not found",
    ...
    def test_duplicate_hostname(self):
        ...
        invalid_config = {
            ...
            "domains": {
                "default": {"name": "Default Domain", "channels": [], "theme": "default"},
                "domain1": {
                    "name": "Domain 1",
                    "channels": [],
                    "theme": "default",
    ...
    def test_get_domain_for_host_direct_match(self):
        ...
        # Direct match
        self.assertEqual(manager.get_domain_for_host("restricted.example.com"), "restricted")
    ...
    def test_get_domain_for_host_with_www(self):
        ...
        self.assertEqual(manager.get_domain_for_host("www.restricted.example.com"), "restricted")
    ...
    def test_get_domain_for_host_with_www_prefix(self):
        ...
        try:
            ...
            self.assertEqual(manager.get_domain_for_host("www.example.org"), "non_www")
        finally:
    ...
    def test_get_domain_for_host_with_port(self):
        ...
        # Hostname with port
        self.assertEqual(manager.get_domain_for_host("restricted.example.com:8080"), "restricted")
    ...
    def test_get_domain_for_host_legacy_match(self):
        ...
        legacy_config = {
            ...
            "domains": {
                "default": {"name": "Default Domain", "channels": [], "theme": "default"},
                "example.net": {"name": "Legacy Domain", "channels": [], "theme": "default"},
            },
        }
        ...
        try:
            ...
            self.assertEqual(manager.get_domain_for_host("example.net"), "example.net")
        finally:
    ...
    def test_get_domain_for_host_default_fallback(self):
        ...
        self.assertEqual(manager.get_domain_for_host("unknown.example.com"), "default")
