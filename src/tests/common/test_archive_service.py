...
class TestArchiveService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = ArchiveConfig(excluded_domains=["localhost", "127.0.0.1", "example.com"])
        ...
        self.archive_disabled_domain = DomainConfig(
            name="Main Site", channels=[], theme="default", auto_archive_enabled=False
        )
    ...
    def test_archive_urls_from_content_with_url_list(self, mock_submit):
        ...
        expected_urls = {"https://wikipedia.org/wiki/Test", "http://news.com/story"}
