...
def edit_quote(quote_id: int) -> ResponseReturnValue:
    ...
    with db.session() as db_session:
        ...
        return render_template(
            "quotes/edit_quote.html", quote=quote, quote_types=QUOTE_TYPES.keys()
        )
...
def view_quote(quote_id: int) -> ResponseReturnValue:
    ...
    with db.session() as db_session:
        ...
        return render_template("quotes/view_quote.html", quote=quote)
...
def search() -> ResponseReturnValue:
    ...
    return redirect(url_for("quotes.list_quotes", search=search_term, type=quote_type))
