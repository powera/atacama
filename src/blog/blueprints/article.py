...
def view_article(slug: str) -> ResponseReturnValue:
    ...
    with db.session() as session:
        ...
        return render_template(
            "articles/article.html", article=article, channel_config=channel_config
        )
...
def edit_article(slug: str) -> ResponseReturnValue:
    ...
    with db.session() as session:
        ...
        return render_template(
            "articles/edit_article.html", article=article, channels=get_channel_manager().channels
        )
...
def submit_article() -> ResponseReturnValue:
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return render_template(
                "articles/submit_article.html",
                error=str(e),
                channels=get_channel_manager().channels,
            )

    # GET request - show form
    return render_template("articles/submit_article.html", channels=get_channel_manager().channels)
